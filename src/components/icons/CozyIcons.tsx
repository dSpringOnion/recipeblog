// Hand-drawn style SVG icons for cozy recipe blog aesthetic

export const CoffeeCupIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 8h2.5c1 0 2 1 2 2.5S20.5 13 19.5 13H17" />
    <path d="M3 8c0-1 1-2 2-2h10c1 0 2 1 2 2v8c0 2.2-1.8 4-4 4H7c-2.2 0-4-1.8-4-4V8Z" />
    <path d="M6 2v4M10 2v4M14 2v4" strokeWidth="1" />
  </svg>
);

export const CookingPotIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 12h20" />
    <path d="M20 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-6" />
    <path d="M6 8V7a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v1" />
    <path d="M2 12v-1c0-1.1.9-2 2-2h16c1.1 0 2 .9 2 2v1" />
  </svg>
);

export const RecipeBookIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
    <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
    <path d="M8 7h8M8 11h6" strokeWidth="1.2" />
  </svg>
);
...
export const PencilIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 3a2.85 2.84 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" />
    <path d="m15 5 4 4" strokeWidth="1.2" />
  </svg>
);
...
export const ClockIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 6v6l4 2" strokeWidth="1.8" />
  </svg>
);
